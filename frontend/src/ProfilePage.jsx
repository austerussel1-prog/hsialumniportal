  ...
  useEffect(() => {
    ...
    const loadNotifications = async () => {
      try {
        ...
        const [conversationsRes, announcementsRes, notificationsRes] = await Promise.all([
        ...
        const announcementNotifications = (Array.isArray(announcementsBody) ? announcementsBody : [])
          ...
          .filter(Boolean);
        const userNotifications = (Array.isArray(notificationsBody?.notifications) ? notificationsBody.notifications : [])
        ...
        const nextNotifications = [...messageNotifications, ...userNotifications, ...announcementNotifications]
